...
public class MainActivity extends Activity implements SensorEventListener, OnClickListener{
 ...
 // Create a constant to convert nanoseconds to seconds.
    ...
    private Button bMoveX;
    private Button bMoveY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bMoveX= (Button) findViewById(R.id.button4);
        bMoveX.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				verifyXMove();
				}
		});
        bMoveY= (Button) findViewById(R.id.button5);
        bMoveY.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				verifyYMove();
				}
    ...
    public final void onSensorChanged(SensorEvent event) {
    	int i=0;
    	 ...
    	 if (timestamp != 0) {
           ...
           if(i==0){
        	   pointX2=(double)gyroscopeOrientation[0];
        	   pointY2=(double)gyroscopeOrientation[1];
    ...
    public void verifyXMove(){
    	...
    	if(Math.abs(pointX2-pointX1)>=0.20 && Math.abs(pointY2-pointY1)<0.15 && count>5){
    		count++;
    ...
    public void verifyYMove(){
    	...
    	double diffY;
    	if(Math.abs(pointY2-pointY1)>=0.10 && Math.abs(pointX2-pointX1)<0.15 && count <5){
    		count++;
